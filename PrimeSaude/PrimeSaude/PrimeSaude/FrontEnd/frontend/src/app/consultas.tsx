<<<<<<< HEAD:PrimeSaude/FrontEnd/frontend/src/app/consultas.tsx
...
const styles = StyleSheet.create({
    ...
    buttonConcluir: { backgroundColor: '#2d5a40', paddingVertical: 10, borderRadius: 8, alignItems: 'center' },
    buttonText: { color: '#FFF', fontWeight: 'bold', fontSize: 14 }
>>>>>>> d3be3dbb19c39ca375a42ee876b31c9ea6ebb110:PrimeSaude/PrimeSaude/FrontEnd/frontend/src/app/consultas.tsx
});