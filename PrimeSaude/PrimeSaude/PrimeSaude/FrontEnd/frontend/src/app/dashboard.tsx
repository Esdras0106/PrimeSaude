<<<<<<< HEAD:PrimeSaude/FrontEnd/frontend/src/app/dashboard.tsx
...
const styles = StyleSheet.create({
  ...
  userBadgeText: { color: '#FFF', fontSize: 18, fontWeight: 'bold' },
  ...
  cardIcon: { color: '#FFF', fontSize: 16, fontWeight: 'bold' },
...
const styles = StyleSheet.create({
  ...
  menuTitle: { fontSize: 16, fontWeight: 'bold', color: '#1a2e22' },
  menuSub: { fontSize: 12, color: '#60646C', marginTop: 2 },
>>>>>>> d3be3dbb19c39ca375a42ee876b31c9ea6ebb110:PrimeSaude/PrimeSaude/FrontEnd/frontend/src/app/dashboard.tsx
});