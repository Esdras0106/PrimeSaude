...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 24, fontWeight: 'bold', color: '#003366', marginBottom: 20, textAlign: 'center', marginTop: 10 },
    list: { paddingBottom: 20 },
    empty: { textAlign: 'center', color: '#666', fontSize: 16, marginTop: 40 },
    card: { backgroundColor: '#FFF', borderRadius: 8, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#E1E4E8', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2 },
    ...
    labelObs: { fontSize: 14, fontWeight: '600', color: '#003366', marginBottom: 6 },
    inputObs: { backgroundColor: '#F9FBFD', borderWidth: 1, borderColor: '#CCC', borderRadius: 6, padding: 10, fontSize: 14, textAlignVertical: 'top', marginBottom: 10 },
    buttonConcluir: { backgroundColor: '#28A745', paddingVertical: 10, borderRadius: 6, alignItems: 'center' },
